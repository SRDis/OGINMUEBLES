...
export default function PropiedadesPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#22AADE] selection:text-black">
      ...
      <header className="relative pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-10 md:pb-12 border-b border-white/5 bg-gradient-to-b from-[#0a0a0a] to-[#050505]">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 mb-3 sm:mb-4">
                <span className="w-6 sm:w-8 h-[1px] bg-[#22AADE]" />
                <span className="text-[#22AADE] text-[9px] sm:text-[10px] font-bold tracking-[0.3em] sm:tracking-[0.4em] uppercase">
                  Catálogo Global
                </span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight tracking-tighter leading-[0.95] sm:leading-none mb-3 sm:mb-4">
                Portafolio <br className="hidden sm:block" />
                <span className="font-bold italic">Inmobiliario</span>
              </h1>
              <p className="text-gray-400 font-light text-sm sm:text-base md:text-lg max-w-xl leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <div>
              <h3 className="text-xl sm:text-2xl font-light text-white mb-3 sm:mb-4">¿Buscas algo <span className="text-[#22AADE] italic font-medium">específico</span>?</h3>
