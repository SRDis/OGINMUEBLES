    ...
    <div>
      ...
      <div className="mb-6">
        <p className="text-gray-600">
          Mostrando <span className="font-semibold text-gray-900">{filteredProperties.length}</span> de{' '}
          <span className="font-semibold text-gray-900">{properties.length}</span> propiedades
        </p>
      </div>
